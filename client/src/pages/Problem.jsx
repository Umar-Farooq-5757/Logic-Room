    ...
    <div className="flex gap-3 px-3 mt-5">
      ...
      >
        ...
        <div>
          ...
          <p className={`${isDark?'bg-transparent border-[#3b3440]':'bg-gray-100 border-gray-200'} border rounded-md shadow-xs px-4 py-2`}>
        ...
        <div>
          ...
          <p className={`${isDark?'bg-transparent border-[#3b3440]':'bg-gray-100 border-gray-200'} border rounded-md shadow-xs px-4 py-2 text-center`}>
            <Math formula={dummyProblemsData[idx].constraints} />
          </p>
        </div>
        {/* Time and memory limit */}
        <div className="flex justify-around items-center my-4">
          <div className={`flex justify-center items-center gap-1 ${isDark?'bg-transparent border-[#3b3440]':'bg-gray-100 border-gray-200'} border shadow-xs rounded-md px-4 py-1.5`}>
        ...
        <div>
          ...
          <p className={` ${isDark?'bg-transparent border-[#3b3440]':'bg-gray-100 border-gray-200'} border rounded-md shadow-xs px-4 py-2 my-3`}>
